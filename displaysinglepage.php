...
<div class='commentFormContainer'>
    ...
    <form method='POST' action='displaysinglepage.php'>
        ...
        <input style='display:none;' type='text' name='commenter_id_aka_user_id' value='<?php echo $_SESSION['user_id'] ?>'>
        ...
        <input style='display:none;' type='text' name='comment_post_id' value='<?php echo $requestedInfo['post_id'] ?>'>
        ...
        <?php else: ?>
            ...
            <button class='commentSubmitBtn' type='submit' name='submit-comment'>Submit Comment</button>
        <?php endif;?>
...
<?php if ($item['comment_parent_id'] <= 0): ?><!--main if statement-->
    <div class="displayCommentBox" id="comment_id<?php echo $item['comment_id']?>">
        ...
        <p>Ola!</p>
        <?php elseif ($_GET['parentId'] == $item['comment_id']): ?> <!--Show Reply Form if this is true-->
